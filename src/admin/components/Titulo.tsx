...
export function Titulo() {
  ...
  return (
    <nav className="bg-blue-700 text-white font-noto border-blue-800 dark:bg-gray-900 flex flex-wrap justify-between fixed z-1 top-0 left-0 w-full z-50c shadow-lg shadow-gray-500/70">
